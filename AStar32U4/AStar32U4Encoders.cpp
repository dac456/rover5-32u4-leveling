...
int16_t AStar32U4Encoders::getCountsLeft()
{
    init();
...
int16_t AStar32U4Encoders::getCountsRight()
{
    init();
...
int16_t AStar32U4Encoders::getCountsAndResetLeft()
{
    init();
...
int16_t AStar32U4Encoders::getCountsAndResetRight()
{
    init();
...
bool AStar32U4Encoders::checkErrorLeft()
{
    init();
...
bool AStar32U4Encoders::checkErrorRight()
{
    init();
